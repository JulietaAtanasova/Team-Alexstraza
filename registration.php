    ...
    <div id="wrapper">
        ...
        <form class="form-reg" method="post">
            ...
            <section class="section-form">
                ...
                <input class="input-txt" id="FirstName" type="text" required="required" title="first-name" placeholder="Име" />

                <label class="lable" for="SecName">Презиме *</label>
                <input class="input-txt" id="SecName" type="text" required="required" title="sec-name" placeholder="Презиме" />

                <label class="lable" for="LastName" placeholder="Име на български">Фамилия *</label>
                <input class="input-txt" id="LastName" type="text" required="required" title="last-nale" placeholder="Фамилия" />
            </section>
            <section class="section-form">

                <label class="lable" for="race">Раса*</label>
                <input class="input-txt" id="race" type="text" required="required" title="" placeholder="Раса" />
            ...
            <section class="section-form">
                ...
                <input class="input-txt" id="gal" type="text" title="" placeholder="Галактика" />

                <label class="lable" for="planet">Планета</label>
                <input class="input-txt" id="planet" type="text" title="" placeholder="Планета" />

                <label class="lable" for="country">Държава</label>
                <input class="input-txt" id="country" type="text" title="" placeholder="Държава" />
            </section>
            </div>
